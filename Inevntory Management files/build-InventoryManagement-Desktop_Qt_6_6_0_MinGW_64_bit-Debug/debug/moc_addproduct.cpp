...
#include "../../InventoryManagement/addproduct.h"
...
static constexpr auto qt_meta_stringdata_CLASSAddProductENDCLASS = QtMocHelpers::stringData(
    "AddProduct",
    "on_add_btn_clicked",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSAddProductENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSAddProductENDCLASS_t qt_meta_stringdata_CLASSAddProductENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "AddProduct"
        QT_MOC_LITERAL(11, 18),  // "on_add_btn_clicked"
        QT_MOC_LITERAL(30, 0)   // ""
    },
    "AddProduct",
    "on_add_btn_clicked",
